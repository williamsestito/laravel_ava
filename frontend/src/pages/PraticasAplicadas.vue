...
const modulos = [
  ...
  { nome: 'Práticas aplicadas', progresso: 20, concluido: true, path: '/curso/modulo/3' },
...
<template>
  <div class="flex flex-col min-h-screen bg-gray-100">
    ...
    <div class="p-4 text-green-600">
      <router-link to="/">Página inicial</router-link> > <router-link to="/curso-dashboard">NR 18 - Segurança</router-link> > <span>Práticas Aplicadas</span>
    </div>
    ...
    <main class="flex-1 p-6 flex gap-6">
      ...
      <section class="flex-1 bg-white p-6 rounded-lg shadow-md">
        ...
        <h2 class="text-2xl font-bold mb-4">Vídeo 001</h2>
        <hr class="mb-4">
      ...
      <aside class="w-1/3 bg-white p-4 rounded-lg shadow-md">
        ...
        <div class="w-full bg-gray-200 rounded-full h-2.5 mb-4">
          <div class="bg-green-600 h-2.5 rounded-full" :style="{ width: modulos[2].progresso + '%' }"></div>
        </div>
        <p class="text-sm text-green-600">{{ modulos[2].progresso }}% Concluído</p>
